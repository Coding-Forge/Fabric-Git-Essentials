...
| [Deployment Manifest Builder](deployment-manifest-builder/index.html) | Release managers, BI leads, platform engineers | Scan existing PBIP folders or manually define deployment ownership, artifacts, environments, parameters, approvals, rollback, and GCC High PBIX/hash metadata | `deployment-manifest.json`, deployment summary Markdown |
